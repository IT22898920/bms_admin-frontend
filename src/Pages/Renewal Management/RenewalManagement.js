...
const RenewalManagement = () => {
    ...
    const fetchDocuments = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BACKEND_URL}/api/document/renewal-preferences-true`,
  ...
  // -- Modal actions (if you use them for uploads, etc.)
  ...
  return (
    <div className="document-management">
      <div className="client-management-header">
        ...
        <p>Business Management System / Renewal Management</p>
      ...
      <div className="filter-row">
        {/* Example "Service" filter - (implementation depends on your app) */}
          ...
          {displayedDocuments.length > 0 ? (
            displayedDocuments.map((doc) => (
              <tr key={doc._id}>
                ...
                <td>
                  {doc.nextRenewalDate
                    ? new Date(doc.nextRenewalDate).toLocaleDateString()
                    : "N/A"}
                </td>
                <td>
                  <Button
